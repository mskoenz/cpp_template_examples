...
// Date:    26.06.2013 18:39:41 EDT
// File:    03_01_use_tpl_like_classes.cpp
...
int main(int argc, char* argv[]) {
    ...
    WAIT_FOR_INPUT()
    PRINT_GREEN("if the template definition is in a .cpp file one needs to")
    PRINT_GREEN("instantiate the wanted types explicity")
