...
// Date:    26.06.2013 14:39:32 EDT
// File:    04_03_simple_trait.cpp
...
//=================== mean trait ===================
//the mean_trait only exists during compiletime.
template<typename T>
struct mean_trait {
    typedef T type;
};
//------------------- full specialization -------------------
//a matching specialisation is always prefered over the general template
template<>
struct mean_trait<int> {
    typedef double type;
};
...
int main(int argc, char* argv[]) {
    ...
    WAIT_FOR_INPUT()
    PRINT_RED("every other integer type needs a specialisation...")
